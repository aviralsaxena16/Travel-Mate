...
2.) Install dependencies: Navigate to the backend and frontend project folder and run the following command to install the required dependencies:
...
5.)Backend will bw running in http://localhost:4000
6.) Also ensure to add .env file in your backend
